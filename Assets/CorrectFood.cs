...
public class CorrectFood : StateMachineBehaviour
{
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        //freeze time and display a dialog box
    }
    ...
    {
        //Destroy(animator.GetComponent<Transform>().parent.GetComponent<Transform>().gameObject);
        spawner.setSpeed(15.00);
    }
